function(yuchen_configure_text_libraries target_name)    
    ...
    target_include_directories(${target_name} PUBLIC ${FREETYPE_DIR}/include ${HARFBUZZ_DIR}/src)
    target_compile_definitions(${target_name} PRIVATE 
        YUCHEN_TEXT_FREETYPE=1 YUCHEN_TEXT_HARFBUZZ=1 FT2_BUILD_LIBRARY=1 HB_HAVE_FREETYPE=1)
endfunction()