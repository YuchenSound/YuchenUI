...
/**
    ...
    @see GraphicsContext, RenderList
*/
...
public:
    ...
    /** Initializes the Metal renderer.
        ...
        Creates device, command queue, and render pipelines.
        
        @param width     Initial width in pixels
        @param height    Initial height in pixels
        @param dpiScale  DPI scale factor (typically 1.0 or 2.0 on Retina)
    ...
    */
    ...
    //======================================================================================
    /** Sets the Metal layer to render to.
        
        @param surface  Pointer to CAMetalLayer
    */
    void setSurface(void* surface) override;
    
    /** Sets the shared Metal device.
        
        Must be called before initialize() if using shared device.
        
        @param device  Pointer to id<MTLDevice>
    */
